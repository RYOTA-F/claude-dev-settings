# CSO エージェント（Athena）スキル一覧

Athena の責務を構成するスキル群。各スキルは独立した責務を持ち、組み合わせて戦略立案を行う。
...
| OKR 管理 | [okr-management.md](okr-management.md) | OKR 設計、進捗モニタリング、達成度評価 |
| ピボット判定 | [pivot-assessment.md](pivot-assessment.md) | 方向転換の判断基準、撤退戦略、新規機会評価 |
